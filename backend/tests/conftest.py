...
# Fixed key so secret encryption/decryption is deterministic across the test
# session, without touching a developer's real backend/.secret_key file.
    ...
    try:
        await db.executescript("""
            ...
            CREATE TABLE IF NOT EXISTS agents (
                ...
                default_secret_names TEXT DEFAULT '[]',
                created_at TEXT DEFAULT (datetime('now')),
